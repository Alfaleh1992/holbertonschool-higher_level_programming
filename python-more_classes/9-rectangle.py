...
class Rectangle:
    """Represents a rectangle with instance tracking and comparison."""

    number_of_instances = 0
    print_symbol = "#"

    def __init__(self, width=0, height=0):
        """Initialize a rectangle and increment instance count."""
        self.width = width
        self.height = height
...
class Square(Rectangle):
    ...
    def __init__(self, size=0):
        """Initialize square using size for both width and height."""
